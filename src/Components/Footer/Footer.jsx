  ...
  <div className="w-full max-w-screen-xl mx-auto p-4 py-2md:py-8">
    <div className="sm:flex sm:items-center sm:justify-between">
      <Link to={"/"} className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
        <img src={Logo} className="w-20" alt="Maui logo" />
      </Link>
    ...
    <span className="block text-sm text-[#0e1c36] sm:text-center">© 2025 <span className="hover:underline text-[#0e1c36]">Ebrahim Nasser™</span>. All Rights Reserved.</span>
  </div>
</footer>
